...
export const firstName = "Ashkan";
export const lastName = "Zahedanaraki";
export const skills = [
  { skill: "HTML" },
  { skill: "C#" },
  { skill: "CSS" },
...
export const selfIntroductionHero = (
  <>
    ...
    <p className="text-lg mt-4 mb-6 md:text-2xl">
      ...
      based in Vancouver, BC. Working towards creating software that makes life
...
export const selfIntroductionAbout = (
  <>
    ...
    <p>
      ...
      that&#39;s what I strive to do, I have a passion for technology and a
      desire to always push the limits of what is possible.
    </p>
  </>
);
